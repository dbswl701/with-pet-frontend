...
function PetsitterDetial() {
  ...
  const showSuccess = (
    ...
    >
      <div>
        <img
          src="https://withpetoriginimage.s3.ap-northeast-1.amazonaws.com/3c4c2c20-fed4-45eb-98ab-de0f677693cc.png"
          alt="성공 아이콘"
        />
      </div>
      <div>
  ...
  const handleShowWarning = () => {
    // eslint-disable-next-line no-alert
    alert(
      "해당 예약건은 이용내역에서 다시 결제를 진행할 수 있습니다. 1일 이내에 결제를 진행하지 않으면 자동으로 예약 취소됩니다."
    );
    setOpen(false);
  };
  ...
  const showPay = (
    ...
    >
      ...
      >
        <p style={{ fontSize: "25px", color: "#CAA969", margin: "0px" }}>
          결제 및 예약정보 확인
        </p>
        <input
          type="button"
        ...
        <div style={{ borderBottom: "1px solid gray" }}>
          <ListItem sx={{ py: 1, px: 0 }}>
            ...
            <Typography variant="body2">
              {payInfo.criticalServicePrice} 원
            </Typography>
          </ListItem>
          {payInfo.reservationServiceResponses &&
            payInfo.reservationServiceResponses.map((service) => (
