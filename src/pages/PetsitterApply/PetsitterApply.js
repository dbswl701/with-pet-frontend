...
function PetsitterApply() {
  ...
  const onSubmit = (e) => {
    e.preventDefault();
    axios
      .post("https://withpet.site/api/v2/applicants", info, {
  ...
  return (
    <FormContainer onSubmit={onSubmit}>
      {/* <S.OuterContainer style={{ marginTop: '50px' }}> */}
      <S.OuterContainer>
        <S.Title
          component="h2"
          variant="h6"
        ...
        <S.Container>
          <S.InnerContainer>
            <div style={{ display: "flex", flexDirection: "column" }}>
              ...
              <LocalizationProvider dateAdapter={AdapterDayjs}>
                <DatePicker
                  value={info.applicantBirth}
                  onChange={(date) => onChange(date, "birth")}
                  name="applicantBirth"
                  format="YYYY/MM/DD"
                />
            ...
            <div>
              ...
              <input
                ...
                style={{ display: "none" }}
              />
              <S.Label htmlFor="O" style={{ border: "1px solid #CAA969" }}>
                흡연
              </S.Label>
              <input
                type="radio"
                ...
                style={{ display: "none" }}
              />
              <S.Label htmlFor="X" style={{ border: "1px solid #CAA969" }}>
                비흡연
              </S.Label>
            </div>
          </S.InnerContainer>
          ...
          <div>
            ...
            <input
              ...
              style={{ display: "none" }}
            />
            <S.Label htmlFor="female" style={{ border: "1px solid #CAA969" }}>
              여성
            </S.Label>
            <input
              type="radio"
              ...
              style={{ display: "none" }}
            />
            <S.Label htmlFor="male" style={{ border: "1px solid #CAA969" }}>
              남성
            </S.Label>
          </div>
        </S.Container>
        ...
        <S.Container>
          <div style={{ marginBottom: "100px" }}>
            ...
            <input
              ...
              style={{ display: "none" }}
            />
            <S.Label htmlFor="having" style={{ border: "1px solid #CAA969" }}>
              O
            </S.Label>
            <input
              type="radio"
              ...
              style={{ display: "none" }}
            />
            <S.Label htmlFor="not" style={{ border: "1px solid #CAA969" }}>
              X
            </S.Label>
          </div>
          ...
          <TextField
            style={{ width: "1190px" }}
            rows={8}
            placeholder="반려 동물 관련 경력 또는 경험에 대해서 알려주세요."
            variant="outlined"
            multiline
            name="applicantAnimalCareer"
            onChange={onChange}
            value={info.applicantAnimalCareer}
            required
          />
        </S.Container>
      </S.OuterContainer>
        ...
        <S.Container>
          <div style={{ marginBottom: "100px" }}>
            ...
            <TextField
              style={{ width: "1190px" }}
              rows={8}
              placeholder="이곳에 직접 입력해주세요."
              multiline
              variant="outlined"
              name="applicantMotivation"
              onChange={onChange}
              value={info.applicantMotivation}
              required
            />
          </div>
          <p>2. 자격증</p>
          ...
          >
            <div style={{}}>
              {info.applicantLicenseImg ? (
                ...
                >
                  <CameraAltIcon
                    style={{ margin: "auto", width: "96px", height: "96px" }}
                  />
                </div>
          ...
          <input
            ...
            id="image-select"
            style={{ display: "none" }}
            name="applicantLicenseImg"
            onChange={(e) => onChange(e, "img")}
          />
        </S.Container>
      </S.OuterContainer>

      <StyledInput
        style={{ margin: "60px auto", width: "302px", marginTop: "72px" }}
        type="submit"
        value="제출"
      />
    </FormContainer>
