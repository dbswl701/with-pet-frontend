...
function Item({
  ...
  let printButton = (
    ...
    >
      <p style={{ fontSize: "6px", margin: "0px", cursor: "pointer" }}>
        예약 취소
      </p>
    </button>
  );
  ...
  const simple = (
    ...
    >
      ...
      <div>
        ...
        >
          <p>
            {item.reservationCheckIn.split("T")[0]} ~{" "}
            {item.reservationCheckOut.split("T")[0]}
          </p>
        </div>
      </div>
      <div
      ...
      >
        ...
        <ChevronLeftOutlinedIcon
          style={{ transform: "rotate( -90deg )", color: "rgb(181, 181, 181)" }}
          fontSize="large"
  ...
  const list = [
    ...
    {
      name: "기간",
      value: `${item.reservationCheckIn.split("T")[0]} ~ ${item.reservationCheckOut.split("T")[0]}`,
    },
    {
      name: "체크인",
      value: `${dayjs(item.reservationCheckIn).format("hh시")}`,
    },
    {
      name: "체크아웃",
      value: `${dayjs(item.reservationCheckOut).format("hh시")}`,
    },
    {
      name: "주소",
  ...
  const paying = (
    <div>
      <button
        ...
        onClick={() => onPaying(item.reservationId)}
      >
  ...
  const reviewBody = (
    <div style={{ display: "flex", flexDirection: "column" }}>
      ...
      <textarea
        ...
        onChange={(e) =>
          setReviewContent({ ...reviewContent, content: e.target.value })
        }
      />
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "row" }}>
        ...
        >
          ...
          {item.reservationServiceResponses &&
            item.reservationServiceResponses.map((service) => {
              return (
...
function WaitList({
  ...
  const steps = ["결제 대기", "예약 대기", "예약 확정", "이용중", "이용 완료"];
