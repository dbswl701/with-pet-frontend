...
import { IAddPetReq, IAddPetRes, IModifyPetReq, IPartiesRes, IPartyReq } from "../pages/PetList/types/parties";
...
// 파티에 반려견 추가
export const postDogIntoParty = async (partyId: number, dogInfo: IAddPetReq) => {
